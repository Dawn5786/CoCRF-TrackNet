...
class Sequence:
    ...
    def __init__(self, name, frames, ground_truth_rect, init_omit):
        self.name = name
        self.frames = frames
        self.ground_truth_rect = ground_truth_rect
        self.init_omit = init_omit
    ...
    def init_bbox(self):
        ...
        # return list(self.ground_truth_rect)
        return list(self.ground_truth_rect[self.init_omit, :])

    def init_omit(self):
        return list(self.init_omit)
